    ...
    if s[snum].bought == True:
            if s[snum].two == 1:
                if s[snum].three == 1:
                    if s[snum].four == 1:
                        print(player1.money)
                        print("A player owns " + board[snum].name + " and the three other stations. You owe this player £"
                              + str(board[snum].four) + " in rent.")
                        player1.money = player1.money - board[snum].four
                        print(player1.money)
                    else:
                        print(player1.money)
                        print("A player owns " + board[snum].name + " and two other stations. You owe this player £" + str(
                            board[snum].three) + " in rent.")
                        player1.money = player1.money - board[snum].three
                        print(player1.money)
                else:
                    print(player1.money)
                    print("A player owns " + board[snum].name + " and one other stations. You owe this player £" + str(
